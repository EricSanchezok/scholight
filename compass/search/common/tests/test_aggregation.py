"""Unit tests for compass.search.common.aggregation — Level 2 chunk→paper fusion.
...
from compass.search.common.aggregation import (
    aggregate_chunks,
...
class TestRerankWithChunks:
    ...
    def test_empty_chunks_keeps_order_unchanged(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        monkeypatch.setattr(
            "compass.search.common.aggregation._abstract_length_penalty",
            lambda x: 1.0,
        )
        hits = [
