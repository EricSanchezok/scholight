...
from compass.search.base import PipelineContext
...
class TestChunkSearchPhase:
    ...
    async def test_two_stage_bm25_then_dense(self):
        ...
        with (
            patch("compass.search.level2.phases._ensure_chunks_loaded"),
            patch(
                "compass.search.level2.phases.bm25_search_all_chunks",
                return_value=bm25_fake,
            ),
            patch(
                "compass.search.level2.phases.search_arxiv_chunks",
