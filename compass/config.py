"""Pydantic Settings for Academic Compass — all config via COMPASS_ env vars."""
...
class Settings(BaseSettings):
    """Application settings with COMPASS_ prefix."""
    ...
    def _sync_jwt_secret(self) -> "Settings":
        # Canonical field is auth_jwt_secret (via COMPASS_AUTH_JWT_SECRET).
    ...
    aliyun_dm_from_alias: str = "Academic Compass"
