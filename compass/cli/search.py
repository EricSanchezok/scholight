"""Compass search CLI — ``compass search`` command with rich terminal diagnostics."""
...
from compass.models.search import SearchHit, SearchRequest, SearchResult
...
def _print_report(result: SearchResult, request: SearchRequest) -> None:
    ...
    click.echo(f"  Academic Compass Search  {click.style(level_str, fg='cyan')}")
