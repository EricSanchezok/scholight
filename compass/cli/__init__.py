"""CLI subcommands — lazy-imported so `compass service sync` doesn't pull search deps."""
...
@click.group()
def cli() -> None:
    """Academic Compass — AI-focused arXiv academic paper search engine."""


cli.add_command(
    _lazy(
        "compass.cli.scheduler",
        "scheduler_group",
        "scheduler",
        group=True,
