...
from compass.api.deps import get_current_user, limiter
from compass.db.client import get_pool
from compass.db.queries_history import get_search_history, log_search, soft_delete_search_entry
from compass.models.history import SearchHistoryEntry
from compass.models.search import SearchRequest, SearchResult
...
async def search(
    ...
    from compass.search.engine import SearchEngine  # lazy — heavy import chain
