...
async def lifespan(_app: FastAPI) -> AsyncIterator[None]:
    ...
    from compass.db.client import close_pool, create_pool
...
def create_app() -> FastAPI:
    ...
    from compass.api.middleware.cors import setup_cors
    ...
    from compass.api.deps import get_current_user, wire_dependencies
    from compass.api.routes.search import router as search_router
