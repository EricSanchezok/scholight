...
Deployment: ``compass service chunk-ingest`` (or cron/systemd timer).
"""
...
from compass.scheduler.base import BaseDaemon, BatchResult
from compass.storage import storage
from compass.store.client import get_client
from compass.store.ingest import update_arxiv_paper, upsert_arxiv_chunks
