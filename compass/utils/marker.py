...
MinerU via ``compass.pipeline.parser``.  Do not add new production callers;
...
# polluted stderr for every process that merely imports compass.utils
...
def marker_block_to_content(
    ...
    if not _DEPRECATION_WARNED:
        ...
        warnings.warn(
            "compass.utils.marker is deprecated and will be removed. "
            "Use compass.pipeline.parser (MinerU) for production workflows.",
            DeprecationWarning,
            stacklevel=2,
        )
