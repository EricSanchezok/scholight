"""Personal deployment must not inherit full-mode workloads or source accounts."""
...
def test_runtime_contains_only_lean_services_and_separate_metadata_credentials() -> None:
    ...
    assert not any("Survey" in name or "Ingest" in name for name in resources)
