"""Core logging configuration for Scholight.
...
from scholight.logging.cleanup import tame_third_party_loggers
...
def _build_renderer(*, use_json: bool | None = None) -> Processor:
    ...
    - None (default): auto-detect — JSON when SCHOLIGHT_LOG_JSON=1
